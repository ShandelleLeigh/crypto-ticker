...
//connect needed to grab coin from redux-store
import {
  Table,
  Header,
  Divider,
...
class CoinList extends React.Component {
  ...
  }  ///necessary to stop interval, because it keeeeps on counting.
  //class is needed to load after component mounts,
  ...
  render() {
    ...
    // value comes from redux-store coins,
    //grab coins out of props
